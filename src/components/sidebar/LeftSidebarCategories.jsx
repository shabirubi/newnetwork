...
export default function LeftSidebarCategories() {
  return (
    <div className="hidden xl:flex w-36 bg-black/70 backdrop-blur-xl border-l border-[#1565C0]/30 self-start sticky top-0 max-h-screen overflow-y-auto flex-col py-3 gap-0.5">
      <style>{`
        @keyframes catPulse {
          0%, 100% { opacity: 1; box-shadow: 0 0 6px var(--cat-color); }
          50% { opacity: 0.6; box-shadow: 0 0 18px var(--cat-color); }
        }
        .cat-item-l { animation: catPulse 2.5s ease-in-out infinite; }
        .cat-item-l:nth-child(2) { animation-delay: 0.2s; }
        .cat-item-l:nth-child(3) { animation-delay: 0.4s; }
        .cat-item-l:nth-child(4) { animation-delay: 0.6s; }
        .cat-item-l:nth-child(5) { animation-delay: 0.8s; }
        .cat-item-l:nth-child(6) { animation-delay: 1.0s; }
        .cat-item-l:nth-child(7) { animation-delay: 1.2s; }
        .cat-item-l:nth-child(8) { animation-delay: 1.4s; }
        .cat-item-l:nth-child(9) { animation-delay: 1.6s; }
        .cat-item-l:nth-child(10) { animation-delay: 1.8s; }
        .cat-item-l:nth-child(11) { animation-delay: 2.0s; }
        .cat-item-l:nth-child(12) { animation-delay: 2.2s; }
        .cat-item-l:nth-child(13) { animation-delay: 2.4s; }
        .cat-item-l:nth-child(14) { animation-delay: 2.6s; }
        .cat-item-l:nth-child(15) { animation-delay: 2.8s; }
        .cat-item-l:nth-child(16) { animation-delay: 3.0s; }
      `}</style>
      {CATEGORIES.map((cat) => {
        const Icon = cat.icon;
        return (
          <Link
            ...
            className="cat-item-l flex flex-col items-center gap-1 px-2 py-2 group cursor-pointer rounded-xl mx-1 hover:bg-white/10 transition-colors"
