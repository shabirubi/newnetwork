...
export default function LeftSidebarCategories() {
  ...
  return (
    <div className="hidden lg:flex w-16 bg-gradient-to-b from-gray-900 via-black to-gray-900 border-l border-purple-900/20 overflow-hidden sticky top-0 h-screen">
