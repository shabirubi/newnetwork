...
export default function RealTimeAlertsContainer() {
  ...
  return (
    <section className="space-y-3 sm:space-y-4 w-full max-w-full overflow-hidden">
      ...
      {/* Alerts Grid */}
      {alerts.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 w-full place-items-center sm:place-items-start max-w-sm sm:max-w-none mx-auto sm:mx-0">
          <AnimatePresence>
