      ...
      >
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-4 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">D-ID Agents</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 bg-black relative">
            <iframe
              src="https://studio.d-id.com/agents/v2_agt_pW1vqMCQ/embed?key=Z29vZ2xlLW9hdXRoMnwxMDkwNTAwMjE4NjYwMDc1ODI0OTY6MUl4RzNNdzRLZkRXVGU3TDBfN3d3"
