...
החזר רק את הכותרות מיום 7.1.2026.`,
  ...
  return (
    <div className="fixed top-20 left-4 bottom-20 sm:bottom-6 w-auto max-w-xs bg-black/80 dark:bg-gray-950/80 backdrop-blur-md text-white py-2 px-3 overflow-hidden z-40 rounded-xl border border-white/10 shadow-2xl flex flex-col">
