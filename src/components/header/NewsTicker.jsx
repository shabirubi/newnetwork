...
החזר רק את הכותרות מיום 7.1.2026.`,
  ...
  return (
    <div className="bg-black dark:bg-gray-950 text-white overflow-hidden relative z-[35]">
      {/* Breaking News Strip */}
      <div className="flex items-center gap-1 sm:gap-3 px-2 lg:px-4 py-2">
      ...
      {/* Broadcast Strip */}
      <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 overflow-hidden border-t border-red-900/20 h-8">
        <motion.div
