...
export default function ReporterChatModal({ reporter, article, onClose }) {
  ...
  // Get reporter response with detailed answers
  const getReporterResponse = async (userMessage) => {
    ...
    if (isSayingThanks) {
      return isFemale ? 
        "בשמחה! אני כאן בשבילכם 24/7. התפקיד שלי זה בדיוק לעדכן אתכם ולענות על כל השאלות. אל תהססו לשאול עוד!" :
        "בשמחה! אני כאן בשבילכם 24/7. התפקיד שלי זה בדיוק לעדכן אתכם ולענות על כל השאלות. אל תהססו לשאול עוד!";
    }

    if (isGreeting) {
      return isFemale ?
        `שלום! אני ${reporter.name}, ${reporter.role} בהרשת החדשה. אני מתמחה ב${reporter.specialty} ועוקבת אחרי כל ההתפתחות בזמן אמת. יש לך שאלה ספציפית או רוצה עדכון כללי על המצב?` :
        `שלום! אני ${reporter.name}, ${reporter.role} בהרשת החדשה. אני מתמחה ב${reporter.specialty} ועוקב אחרי כל ההתפתחויות בזמן אמת. יש לך שאלה ספציפית או רוצה עדכון כללי על המצב?`;
    }

    // Build detailed response based on specialty
    const specialtyResponses = {
      'ביטחון ומדיניות': isFemale ? [
        `שאלה מצוינת. כמי שעוקבת אחרי התחום הביטחוני מקרוב, אני יכולה להגיד שהמצב מורכב. דיברתי עם מקורות בכירים והם מדגישים שצריך להבין את כל המרכיבים. זה נושא שמשפיע על כולנו ואני ממשיכה לעקוב מקרוב.`,
        `זה בדיוק התחום שלי. המצב הביטחוני משתנה כל הזמן ואני בקשר צמוד עם המקורות בשטח. מה שחשוב להבין זה שיש כאן מספר שכבות - יש את המימד הביטחוני הישיר, אבל גם את ההשלכות המדיניות. אני ממשיכה לחקור ולעדכן.`,
        `שאלת את השאלה הנכונה. כמי שמכסה את הזירה הביטחונית, אני יכולה להגיד שהנושא הזה מורכב מאוד. בדקתי עם מספר גורמים ביטחוניים והתמונה שמתקבלת היא שצריך להישאר מעודכנים. אני עוקבת אחרי כל התפתחות ואעדכן ברגע שיהיה משהו חדש.`
      ] : [
        `שאלה מצוינת. כמי שעוקב אחרי התחום הביטחוני מקרוב, אני יכול להגיד שהמצב מורכב. דיברתי עם מקורות בכירים והם מדגישים שצריך להבין את כל המרכיבים. זה נושא שמשפיע על כולנו ואני ממשיך לעקוב מקרוב.`,
        `זה בדיוק התחום שלי. המצב הביטחוני משתנה כל הזמן ואני בקשר צמוד עם המקורות בשטח. מה שחשוב להבין זה שיש כאן מספר שכבות - יש את המימד הביטחוני הישיר, אבל גם את ההשלכות המדיניות. אני ממשיך לחקור ולעדכן.`,
        `שאלת את השאלה הנכונה. כמי שמכסה את הזירה הביטחונית, אני יכול להגיד שהנושא הזה מורכב מאוד. בדקתי עם מספר גורמים ביטחוניים והתמונה שמתקבלת היא שצריך להישאר מעודכנים. אני עוקב אחרי כל התפתחות ואעדכן ברגע שיהיה משהו חדש.`
      ],
      'כלכלה ועסקים': isFemale ? [
        `שוק ההון זה בדיוק התחום שלי. מה שאני רואה עכשיו זה שיש תנודתיות גבוהה והמשקיעים צריכים להיות זהירים. דיברתי עם אנליסטים בכירים והם ממליצים לבחון היטב את ההזדמנויות. המצב הכלכלי משפיע על כולנו ואני ממשיכה לעקוב אחרי הנתונים.`,
        `זו שאלה שהרבה שואלים אותי. המצב הכלכלי משתנה מהר והשווקים מגיבים לכל חדשה. בדקתי את הנתונים האחרונים וניתן לראות מגמות מעניינות. חשוב להבין שיש גורמים רבים שמשפיעים - מקומיים וגלובליים. אני עוקבת אחרי כל העדכונים.`,
        `שאלה מצוינת. כמי שמכסה את השוק הפיננסי, אני יכולה להגיד שהמצב דינמי מאוד. דיברתי עם מנהלי תיקים והם מדגישים שצריך להסתכל על התמונה הרחבה. יש הזדמנויות אבל גם סיכונים. אני ממשיכה לעקוב ולעדכן.`
      ] : [
        `שוק ההון זה בדיוק התחום שלי. מה שאני רואה עכשיו זה שיש תנודתיות גבוהה והמשקיעים צריכים להיות זהירים. דיברתי עם אנליסטים בכירים והם ממליצים לבחון היטב את ההזדמנויות. המצב הכלכלי משפיע על כולנו ואני ממשיך לעקוב אחרי הנתונים.`,
        `זו שאלה שהרבה שואלים אותי. המצב הכלכלי משתנה מהר והשווקים מגיבים לכל חדשה. בדקתי את הנתונים האחרונים וניתן לראות מגמות מעניינות. חשוב להבין שיש גורמים רבים שמשפיעים - מקומיים וגלובליים. אני עוקב אחרי כל העדכונים.`,
        `שאלה מצוינת. כמי שמכסה את השוק הפיננסי, אני יכול להגיד שהמצב דינמי מאוד. דיברתי עם מנהלי תיקים והם מדגישים שצריך להסתכל על התמונה הרחבה. יש הזדמנויות אבל גם סיכונים. אני ממשיך לעקוב ולעדכן.`
      ]
    };

    // Get response by specialty or use default
    const responses = specialtyResponses[reporter.specialty] || (isFemale ? [
      `זו שאלה מעולה שאני מקבלת הרבה. כמי שמכסה את ${reporter.specialty}, אני יכולה להגיד שהנושא הזה חשוב מאוד. דיברתי עם מקורות רלוונטיים והם מדגישים שצריך להבין את המורכבות. אני ממשיכה לעקוב ולעדכן בזמן אמת.`,
      `שאלה מצוינת. התחום של ${reporter.specialty} זה בדיוק מה שאני עושה. המצב משתנה כל הזמן ואני בקשר צמוד עם כל השחקנים המרכזיים. יש כאן הרבה היבטים שצריך להבין ואני כאן בשביל לעזור לכם להתמצא. אני עוקבת אחרי כל העדכונים.`,
      `זה בדיוק מה שאני מכסה! הנושא של ${reporter.specialty} מרתק ומורכב. בדקתי לעומק והיו כמה התפתחויות חשובות לאחרונה. המסקנה שלי היא שצריך להישאר מעודכנים ולהבין את הדינמיקה. אני ממשיכה לחקור ולדווח.`
    ] : [
      `זו שאלה מעולה שאני מקבל הרבה. כמי שמכסה את ${reporter.specialty}, אני יכול להגיד שהנושא הזה חשוב מאוד. דיברתי עם מקורות רלוונטיים והם מדגישים שצריך להבין את המורכבות. אני ממשיך לעקוב ולעדכן בזמן אמת.`,
      `שאלה מצוינת. התחום של ${reporter.specialty} זה בדיוק מה שאני עושה. המצב משתנה כל הזמן ואני בקשר צמוד עם כל השחקנים המרכזיים. יש כאן הרבה היבטים שצריך להבין ואני כאן בשביל לעזור לכם להתמצא. אני עוקב אחרי כל העדכונים.`,
      `זה בדיוק מה שאני מכסה! הנושא של ${reporter.specialty} מרתק ומורכב. בדקתי לעומק והיו כמה התפתחויות חשובות לאחרונה. המסקנה שלי היא שצריך להישאר מעודכנים ולהבין את הדינמיקה. אני ממשיך לחקור ולדווח.`
    ]);
