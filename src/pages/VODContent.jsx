          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex items-center justify-between mb-6">
              <Link to={createPageUrl("Home")} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                <div className="w-12 h-12 bg-gradient-to-br from-[#E31E24] to-[#B91C1C] rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-xl">▶</span>
                </div>
                <div>
                  <h1 className="text-2xl font-bold text-white">עולם התוכן</h1>
                  <p className="text-xs text-gray-400">הרשת החדשה</p>
                </div>
              </Link>
            </div>
