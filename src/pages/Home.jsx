...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black space-y-0 sm:space-y-6">
      ...
      {/* Live Player Section - Always Visible */}
      <section className="px-0 mb-6 -mx-4 sm:mx-0">
        <div className="relative w-full bg-black rounded-none sm:rounded-2xl overflow-hidden shadow-2xl border-2 border-[#00D9FF]/50" style={{boxShadow: '0 0 40px rgba(0, 217, 255, 0.4)'}}>
          <LivePlayer 
            title={finalTitle}
